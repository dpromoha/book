...
internal enum Asset {
  ...
  internal static let dogPlaceholder = ImageAsset(name: "dog_placeholder")
  internal static let harryPotterBackground = ImageAsset(name: "harry_potter_background")
  internal static let hp = ImageAsset(name: "hp")
